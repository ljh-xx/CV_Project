...
def resnet18(weight: Any = None, num_classes: int = 1000):
    return _resnet(BasicBlock, [2, 2, 2, 2], weight, num_classes=num_classes)
...
class SEBasicBlock(BasicBlock):
    """BasicBlock with Squeeze-and-Excitation after the second BN"""
    expansion = 1
